...
export async function loginAction(prevState: LoginValidationResult, formData: FormData): Promise<LoginValidationResult> {
  try {
...
export async function registerAction(prevState: RegisterValidationResult, formData: FormData): Promise<RegisterValidationResult> {
  try {
